...
if
$\overline{u_0} ≥ \underline{u_0} $
and
$\overline{u_1} + \overline{u_0}/2 ≥ \underline{u_1} + \underline{u_0}/2$
,
then the solutions
$\overline{u}$
of
...
$C(t,r,ρ, ε_1) = G(t,r,ρ, ε_1)$ because $C(⋅,r,ρ, ε_1)$ is increasing.
